defmodule Sneakers23Web.ProductChannelTest do
  ...
  describe "notify_product_released/1" do
    test "the size selector for the production is broadcasted" do
      ...
      # assert html string contains what's in _sizes.html.eex
 ...
 describe "notify_item_stock_change/1" do
   setup _ do
     ...
     Endpoint.subscribe(topic)
      ...
      # return values here merged into `context` (state for tests)
