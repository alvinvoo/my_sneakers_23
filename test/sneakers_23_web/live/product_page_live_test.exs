defmodule Sneakers23Web.ProductPageLiveTest do
  ...
  setup _ do
    ...
    #IO.puts inspect inventory
    # setting inventory into the Server's state
  ...
  test "sold out items are picked up", %{conn: conn, inventory: inventory} do
    ...
    release_all(inventory)
    sell_all(inventory)
    Process.sleep(100) # pubsub thing needs to wait before can sell everything, but how to get process id?
    html = render(view)
