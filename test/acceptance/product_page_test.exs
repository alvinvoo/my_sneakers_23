defmodule Acceptance.ProductPageTest do
  ...
  setup do
    ...
    # metadata here => %{owner: #PID<0.547.0>, repo: Sneakers23.Repo}
    # just passing some metadata to a hound session
    # can be extracted later with Hound.Metadata.extract(<user_agent_string>)
